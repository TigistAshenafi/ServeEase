...
abstract class AppLocalizations {
  ...
  /// No description provided for @afterVerificationProvider.
  ///
  /// In en, this message translates to:
  /// **'After verification, you will be redirected to complete your provider profile setup.'**
  String get afterVerificationProvider;

  /// No description provided for @afterVerificationSeeker.
  ///
  /// In en, this message translates to:
  /// **'After verification, you will be taken to your dashboard.'**
  String get afterVerificationSeeker;
  ...
  /// Message shown when reset code is sent
  ///
  /// In en, this message translates to:
